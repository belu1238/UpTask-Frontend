...
export default function RequestNewCodeView() {
    const initialValues: RequestConfirmationCodeForm = {
        email: '' // Valor inicial vacío para el campo de email
    }
    ...
    const handleRequestCode = (formData: RequestConfirmationCodeForm) => mutate(formData) // Llamar a la mutación con los datos del formulario
    ...
    return (
        <>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                ...
                >
                    ¿Ya tienes cuenta? <span className="hover:text-fuchsia-600">Iniciar Sesión</span>
                </Link>
                <Link
                    to='/auth/forgot-password'
                    className="text-center text-gray-300 font-normal"
                >
                    ¿Olvidaste tu contraseña? <span className="hover:text-fuchsia-600">Reestablecer</span>
                </Link>
            </nav>
        </>
    )
